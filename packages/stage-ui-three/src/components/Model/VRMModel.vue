...
import { useVRMTalkingSway } from '../../composables/vrm/talking-sway'
...
const talkingSway = useVRMTalkingSway()
    ...
    try {
      ...
      */
      ...
      disposeBeforeRenderLoop = onBeforeRender(({ delta }) => {
        ...
        // Procedural talking sway – subtle head/neck/spine motion while character is speaking
        talkingSway.update(activeVrm, delta, props.isSpeaking)
